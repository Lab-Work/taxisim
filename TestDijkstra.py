...
class TestDijkstra:
    ...
    #These labels contain each node's distance from each origin (boundary nodes for a specific region)
    #params:
    ...
    def run(grid_of_nodes, region_i, region_j, outfile, warmstart=True, use_domination_value=False):
        ...
        DijkstrasAlgorithm.dijkstra(boundary_nodes, grid_of_nodes, warmstart, use_domination_value)        
...
if __name__ == '__main__':
    ...
    regions_of_interest = [(0,0), (10,10), (11, 5), (17,6), (16,4), (19,18), (17,3), (18,2)]
    
    #For each of the regions, compute the answer using several variations on Dijkstras algorithm
    ...
    for (i,j) in regions_of_interest:
        ...
        print("---------Minkey Warm")
        TestDijkstra.run(grid_of_nodes, i, j, "test_output/nodes_" + str(i) + "_" + str(j) + "_minkey_warmstart.csv", True, False)
        print("---------Domkey Cold")
